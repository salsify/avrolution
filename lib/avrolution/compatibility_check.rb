...
module SalsifyAvro
  module Compatibility
    class Check
      ...
      def initialize(logger: SalsifyAvro::Compatibility::PassthruLogger.new($stdout))
        @incompatible_schemas = []
        @schema_registry = build_schema_registry
        @compatibility_breaks = SalsifyAvro::Compatibility::CompatibilityBreaksFile.load
        @logger = logger
      end
      ...
      def check_schema_compatibility(file)
        schema = SalsifyAvro::Schema.parse(File.read(file))
